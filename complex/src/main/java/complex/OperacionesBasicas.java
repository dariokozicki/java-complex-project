...
public class OperacionesBasicas {
	public static Punto resta(Punto complejo1,Punto complejo2) {
	...
	public static Punto multiplicacion(Punto complejo1,Punto complejo2) {
	...
	public static Punto cociente(Punto complejo1,Punto complejo2) {
